...
$('.s_pdf').on('click', function () {
  ...
  $(this).attr({ target: '_blank', href: '/randomfile.pdf' });

});

$('.s_music').on('click', function () {

  $(this).attr({ target: '_blank', href: '/music/hey.mp3' });
...
if ($(".audio-player")[0]) {
  ...
  var listAudio = [

    {
      ...
      file: "https://winsfolio.net/blesso//music/audio-2.mp3",
...

    {
      ...
      file: "https://winsfolio.net/blesso//music/audio-4.mp3",
...

    {
      ...
      file: "https://winsfolio.net/blesso//music/audio-3.mp3",
...

    {
      ...
      file: "https://winsfolio.net/blesso//music/audio-1.mp3",
...

    {
      ...
      file: "https://winsfolio.net/blesso//music/audio-5.mp3",
